...
<script>
	...
	$("#getCheckedAll").click(function() {
			...
			location.href="/mvProject/movieDetail/charmPointregit.do?mv_seq="+$('#mv_seq').val()+
			...
			if($('#charmpoint').val() == 1){
			var seq =$('#mv_seq').val();
			opener.location.href='/mvProject/movieDetail/movieDetail.do?seq'+${seq}+'mv_seq='+$('#mv_seq').val()+
			'&movienameforkr='+$('#movienameforkr').val()+
			'&page='+$('#page').val(); 
			window.close();
			}
