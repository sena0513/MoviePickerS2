...
<link href="<c:url value="../res/css/member/smssend.css" />" rel="stylesheet">
   ...
   <form method="post" id="verificationForm"  name="smsForm" action="/mvProject/member/pwSearchResult.do">
      ...
      <div id="bodyWrapper">
         ...
         <input type="hidden" name="id" value="${id}">
            ...
            <div class="nameDiv">
               <div class="inputNameDiv"><input type="text" name="userInputVerificationcode" id="userInputVerificationcode"></div> 
            </div>
            
            
            <div class="bottomButtonMenu">
                  <input type="button" value="확인" id="ok_button">
                  <input type="button" value="취소" class="cancel_button"
